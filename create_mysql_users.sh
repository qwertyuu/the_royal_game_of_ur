...
mysql -uroot -e "CREATE USER 'ur'@'%' IDENTIFIED BY 'qwerty'" && \
mysql -uroot -e "GRANT ALL PRIVILEGES ON *.* TO 'ur'@'%' WITH GRANT OPTION" && \
mysql -uroot -e "CREATE DATABASE IF NOT EXISTS ur" && \
mysql -uroot -e "GRANT ALL PRIVILEGES ON ur.* TO 'ur'@'%'" && \
mysql -uroot ur < /app/ur.sql
